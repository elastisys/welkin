...
- Update local Cluster setup & documentation
- Fix OpenSearch tests with mapping names containing hyphens
- Purge yq3, enforce yq4 in the requirements
