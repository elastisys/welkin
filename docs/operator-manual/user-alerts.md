...
1. Ensure [user.alertmanager.enabled](schema/config-properties-user-config-properties-alertmanager-config/#enabled) is **true**.
1. Ensure [user.alertmanager.ingress.enabled](schema/config-properties-user-config-properties-alertmanager-config/#ingress) is **false**.
