...
> [!NOTE]
> These docs will only include maintenance steps for Kubespray and not Cluster-API.
...
1. Check and follow the migration document for the release you want to upgrade to: <https://github.com/elastisys/compliantkubernetes-apps/tree/main/migration>
...
1. Pull the latest changes, switch to the correct branch and update the `Kubespray` submodule:
...
1. Check and follow the migration document for the release you want to upgrade to: <https://github.com/elastisys/compliantkubernetes-kubespray/tree/main/migration>
