...
1. Yes, use Managed Kubernetes services if they provide sufficient functionality.
1. No, we do not use Managed Kubernetes services because we want to reduce QA complexity and keep platform portability.
